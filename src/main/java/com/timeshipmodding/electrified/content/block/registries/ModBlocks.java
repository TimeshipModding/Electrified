...
import com.timeshipmodding.electrified.content.block.PowerSupplyBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> POWER_SUPPLY = registerBlock("power_supply", () -> new PowerSupplyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).noOcclusion().requiresCorrectToolForDrops().strength(3.0F, 6.0F)));
