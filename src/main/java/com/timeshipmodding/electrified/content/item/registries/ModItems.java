...
public class ModItems {
    ...
    public static final DeferredItem<Item> GOLD_SHEET = ITEMS.register("gold_sheet", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> ALUMINIUM_WIRE_SPOOL = ITEMS.register("aluminium_wire_spool", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> COPPER_WIRE_SPOOL = ITEMS.register("copper_wire_spool", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> GOLD_WIRE_SPOOL = ITEMS.register("gold_wire_spool", () -> new Item(new Item.Properties()));
